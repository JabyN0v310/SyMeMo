...
public class ptnRegistroPaciente extends JFrame {
	...
	public ptnRegistroPaciente() 
	{
	    ...
	    getContentPane().add(pnlGridBag,BorderLayout.CENTER);
	    ...
	    gbc_btnRegistrar.gridheight = 2;
	    gbc_btnRegistrar.gridwidth = 2;
	    gbc_btnRegistrar.insets = new Insets(0, 0, 5, 5);
	    gbc_btnRegistrar.gridx = 8;
	    gbc_btnRegistrar.gridy = 1;
	    pnlGridBag.add(btnRegistrar, gbc_btnRegistrar);
	...
	{
		ptnRegistroPaciente rp=new ptnRegistroPaciente();
		rp.setVisible(true);
	}*/
}
